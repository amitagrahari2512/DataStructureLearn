 ...
 *
 */
public class ChocolatePickUp3DDpTabulationMostOptimize {
	...
	public static void main(String[] args) {
		...
		ChocolatePickUp3DDpTabulationMostOptimize choco = new ChocolatePickUp3DDpTabulationMostOptimize();
		System.out.println("Maximum Chocolates : " + choco.maximumChocolates(arr, r, c));
	}
	
	
	public int maximumChocolates(int[][] arr, int m, int n ) {
		...
		for(int i = m - 2; i>=0 ; i--) {
			...
			//update the front row with curr
			for(int a = 0 ; a < n ;a++) {
