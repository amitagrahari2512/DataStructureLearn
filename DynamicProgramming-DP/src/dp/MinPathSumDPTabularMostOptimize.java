...
public class MinPathSumDPTabularMostOptimize {
	public static void main(String[] args) {
		...
		MinPathSumDPTabularMostOptimize min = new MinPathSumDPTabularMostOptimize();
		System.out.println("Min Path Value : " + min.minPathSum(arr));
