...
public class UniquePathsMazeObstaclesDP {
	...
	public static void main(String[] args) {
		...
		UniquePathsMazeObstaclesDP u = new UniquePathsMazeObstaclesDP();
		
		System.out.println("Unique Path : " + u.uniquePath(arr, dp, m - 1, n - 1));
	}
	
	public int uniquePath(int[][] arr, int[][] dp, int i, int j) {
		...
		int up = uniquePath(arr, dp, i - 1, j);
		int left = uniquePath(arr, dp,  i, j - 1);
