...
public class UniquePathsRecurssion {
	...
	public static void main(String[] args) {
		...
		int m = arr.length;
		int n = arr[0].length;
		UniquePathsRecurssion u = new UniquePathsRecurssion();
		
		System.out.println("Unique Path : " + u.uniquePath(m - 1, n - 1));
	}
	
	public int uniquePath(int i, int j) {
		if(i == 0 && j == 0) return 1;
