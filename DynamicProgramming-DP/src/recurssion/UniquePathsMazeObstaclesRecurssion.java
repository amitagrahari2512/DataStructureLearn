...
public class UniquePathsMazeObstaclesRecurssion {
	...
	public static void main(String[] args) {
		...
		int m = arr.length;
		int n = arr[0].length;
		UniquePathsMazeObstaclesRecurssion u = new UniquePathsMazeObstaclesRecurssion();
		
		System.out.println("Unique Path : " + u.uniquePath(arr, m - 1, n - 1));
	}
	
	public int uniquePath(int[][] arr, int i, int j) {
		...
		int up = uniquePath(arr,i - 1, j);
		int left = uniquePath(arr, i, j - 1);
