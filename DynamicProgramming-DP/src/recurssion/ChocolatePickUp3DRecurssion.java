 ...
 *
 */
public class ChocolatePickUp3DRecurssion {
	...
	public static void main(String[] args) {
		...
		ChocolatePickUp3DRecurssion choco = new ChocolatePickUp3DRecurssion();
		System.out.println("Maximum Chocolates : " + choco.maximumChocolates(arr, r, c, 0 , 0, r-1));
	}
	
	
	public int maximumChocolates(int[][] arr, int r, int c ,int i, int j1, int j2) {
		...
		for(int di = -1 ; di <= 1 ; di++) {
			for(int dj = -1 ; dj <= 1 ; dj++) {
				...
				value+=maximumChocolates(arr, r, c, i + 1, j1+di, j2+dj);
